...
var _user$project$ViewUtil$platformGap = 150;
var _user$project$ViewUtil$leftBuffer = 100;
var _user$project$ViewUtil$platformBuffer = 70;
var _user$project$ViewUtil$platformHeight = 40;
var _user$project$ViewUtil$height = 570;
var _user$project$ViewUtil$halfHeight = _user$project$ViewUtil$height / 2;
var _user$project$ViewUtil$onGround = ((0 - _user$project$ViewUtil$halfHeight) + (_user$project$ViewUtil$platformHeight / 2)) + _user$project$ViewUtil$platformBuffer;
var _user$project$ViewUtil$pit = (0 - _user$project$ViewUtil$halfHeight) - _user$project$ViewUtil$platformBuffer;
var _user$project$ViewUtil$width = 1000;
var _user$project$ViewUtil$halfWidth = _user$project$ViewUtil$width / 2;
var _user$project$ViewUtil$left = (0 - _user$project$ViewUtil$halfWidth) + _user$project$ViewUtil$leftBuffer;
var _user$project$ViewUtil$twiceWidth = _user$project$ViewUtil$width * 2;

var _user$project$Game_Avatar_Model$defaultSpeed = 7.0;
var _user$project$Game_Avatar_Model$jumpVelocity = 10.0;
var _user$project$Game_Avatar_Model$Speed = F2(
	function (a, b) {
		return {multiplier: a, timeLimit: b};
	});
var _user$project$Game_Avatar_Model$Invincible = F2(
	function (a, b) {
		return {isInvincible: a, timeLimit: b};
	});
var _user$project$Game_Avatar_Model$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {x: a, y: b, vx: c, vy: d, dir: e, hp: f, speed: g, invincible: h, score: i};
	});
var _user$project$Game_Avatar_Model$Unknown = {ctor: 'Unknown'};
var _user$project$Game_Avatar_Model$Enter = {ctor: 'Enter'};
var _user$project$Game_Avatar_Model$Escape = {ctor: 'Escape'};
var _user$project$Game_Avatar_Model$SpaceBar = {ctor: 'SpaceBar'};
var _user$project$Game_Avatar_Model$RightArrowKey = {ctor: 'RightArrowKey'};
var _user$project$Game_Avatar_Model$LeftArrowKey = {ctor: 'LeftArrowKey'};
var _user$project$Game_Avatar_Model$Right = {ctor: 'Right'};
var _user$project$Game_Avatar_Model$model = {
	x: _user$project$ViewUtil$left,
	y: _user$project$ViewUtil$onGround,
	vx: 0,
	vy: 0,
	dir: _user$project$Game_Avatar_Model$Right,
	hp: 100,
	speed: {multiplier: 1.0, timeLimit: 0},
	invincible: {isInvincible: false, timeLimit: 0},
	score: 0
};
var _user$project$Game_Avatar_Model$Left = {ctor: 'Left'};

var _user$project$Game_GamePlatform_Model$Model = F4(
	function (a, b, c, d) {
		return {w: a, x: b, y: c, unit: d};
	});
var _user$project$Game_GamePlatform_Model$PlatformToGenerate = F3(
	function (a, b, c) {
		return {w: a, heightDiff: b, unit: c};
	});
var _user$project$Game_GamePlatform_Model$None = {ctor: 'None'};
var _user$project$Game_GamePlatform_Model$Shield = {ctor: 'Shield'};
var _user$project$Game_GamePlatform_Model$Boost = {ctor: 'Boost'};
var _user$project$Game_GamePlatform_Model$ThreeBones = {ctor: 'ThreeBones'};
var _user$project$Game_GamePlatform_Model$TwoBones = {ctor: 'TwoBones'};
var _user$project$Game_GamePlatform_Model$HP = {ctor: 'HP'};
var _user$project$Game_GamePlatform_Model$Zombie = function (a) {
	return {ctor: 'Zombie', _0: a};
};
var _user$project$Game_GamePlatform_Model$Waste = {ctor: 'Waste'};
var _user$project$Game_GamePlatform_Model$Spikes = {ctor: 'Spikes'};
var _user$project$Game_GamePlatform_Model$model = A4(_user$project$Game_GamePlatform_Model$Model, 200, (0 - _user$project$ViewUtil$halfWidth) / 2, (0 - _user$project$ViewUtil$halfHeight) / 2, _user$project$Game_GamePlatform_Model$Spikes);
var _user$project$Game_GamePlatform_Model$ground = A4(_user$project$Game_GamePlatform_Model$Model, _user$project$ViewUtil$width / 2, 0 - _user$project$ViewUtil$halfWidth, (0 - _user$project$ViewUtil$halfHeight) + (_user$project$ViewUtil$platformHeight / 2), _user$project$Game_GamePlatform_Model$Spikes);
var _user$project$Game_GamePlatform_Model$Right = {ctor: 'Right'};
var _user$project$Game_GamePlatform_Model$Left = {ctor: 'Left'};
...
var _user$project$Game_Avatar_View$avatarForm = function (avatar) {
	var idle_right = '../graphic/avatar/idle/right.gif';
	var idle_left = '../graphic/avatar/idle/left.gif';
	var die_right = '../graphic/avatar/die/right.gif';
	var die_left = '../graphic/avatar/die/left.gif';
	var jump_right = '../graphic/avatar/jump/right.gif';
	var jump_left = '../graphic/avatar/jump/left.gif';
	var run_right = '../graphic/avatar/run/right.gif';
	var run_left = '../graphic/avatar/run/left.gif';
	var walk_right = '../graphic/avatar/walk/right.gif';
	var walk_left = '../graphic/avatar/walk/left.gif';
	var avatarHeight = 153;
	var avatarWidth = 116;
	if (_elm_lang$core$Native_Utils.cmp(avatar.hp, 0) < 1) {
		var _p0 = avatar.dir;
		if (_p0.ctor === 'Left') {
			return _evancz$elm_graphics$Collage$group(
				{
					...
					_0: A2(
						...
						_evancz$elm_graphics$Collage$toForm(
							A3(_evancz$elm_graphics$Element$image, avatarHeight, avatarHeight, die_right))),
					_1: _elm_lang$core$List$singleton(
						A2(
							_evancz$elm_graphics$Collage$alpha,
							1,
							_evancz$elm_graphics$Collage$toForm(
								A3(_evancz$elm_graphics$Element$image, avatarHeight, avatarHeight, die_left))))
				});
		} else {
			return _evancz$elm_graphics$Collage$group(
				{
		...
		if (!_elm_lang$core$Native_Utils.eq(avatar.vy, 0)) {
			var _p1 = avatar.dir;
			if (_p1.ctor === 'Left') {
				return _evancz$elm_graphics$Collage$group(
					{
						...
						_0: A2(
							...
							0,
							_evancz$elm_graphics$Collage$toForm(
								A3(_evancz$elm_graphics$Element$image, avatarWidth, avatarHeight, walk_left))),
						_1: {
							ctor: '::',
							_0: A2(
								_evancz$elm_graphics$Collage$alpha,
								0,
								_evancz$elm_graphics$Collage$toForm(
									A3(_evancz$elm_graphics$Element$image, avatarWidth, avatarHeight, walk_right))),
							_1: {
								ctor: '::',
								_0: A2(
									_evancz$elm_graphics$Collage$alpha,
									0,
									_evancz$elm_graphics$Collage$toForm(
										A3(_evancz$elm_graphics$Element$image, avatarWidth, avatarHeight, run_left))),
								_1: {
									ctor: '::',
									_0: A2(
										_evancz$elm_graphics$Collage$alpha,
										0,
										_evancz$elm_graphics$Collage$toForm(
											A3(_evancz$elm_graphics$Element$image, avatarWidth, avatarHeight, run_right))),
									_1: {
										ctor: '::',
										_0: A2(
											_evancz$elm_graphics$Collage$alpha,
											0,
											_evancz$elm_graphics$Collage$toForm(
												A3(_evancz$elm_graphics$Element$image, avatarWidth, avatarHeight, die_left))),
										_1: {
											ctor: '::',
											_0: A2(
												_evancz$elm_graphics$Collage$alpha,
												0,
												_evancz$elm_graphics$Collage$toForm(
													A3(_evancz$elm_graphics$Element$image, avatarWidth, avatarHeight, die_right))),
											_1: {
												ctor: '::',
												_0: A2(
													_evancz$elm_graphics$Collage$alpha,
													0,
													_evancz$elm_graphics$Collage$toForm(
														A3(_evancz$elm_graphics$Element$image, avatarWidth, avatarHeight, idle_left))),
												_1: {
													ctor: '::',
													_0: A2(
														_evancz$elm_graphics$Collage$alpha,
														0,
														_evancz$elm_graphics$Collage$toForm(
															A3(_evancz$elm_graphics$Element$image, avatarWidth, avatarHeight, idle_right))),
													_1: {
														ctor: '::',
														_0: A2(
															_evancz$elm_graphics$Collage$alpha,
															0,
															_evancz$elm_graphics$Collage$toForm(
																A3(_evancz$elm_graphics$Element$image, avatarWidth, avatarHeight, jump_right))),
														_1: _elm_lang$core$List$singleton(
															A2(
																_evancz$elm_graphics$Collage$alpha,
																1,
																_evancz$elm_graphics$Collage$toForm(
																	A3(_evancz$elm_graphics$Element$image, avatarWidth, avatarHeight, jump_left))))
													}
												}
											}
										}
			...
			if (!_elm_lang$core$Native_Utils.eq(avatar.vx, 0)) {
				if (_elm_lang$core$Native_Utils.cmp(avatar.speed.multiplier, 1.5) > -1) {
					var _p2 = avatar.dir;
					if (_p2.ctor === 'Left') {
						return _evancz$elm_graphics$Collage$group(
							{
...
var _user$project$Game_Model$msPerUpdate = 15.0;
var _user$project$Game_Model$Model = F3(
	function (a, b, c) {
		return {state: a, platforms: b, avatar: c};
	});
var _user$project$Game_Model$Over = {ctor: 'Over'};
var _user$project$Game_Model$Playing = {ctor: 'Playing'};
var _user$project$Game_Model$model = {
	state: _user$project$Game_Model$Playing,
	platforms: {
		ctor: '::',
		_0: _user$project$Game_GamePlatform_Model$model,
		_1: {
			ctor: '::',
			_0: _user$project$Game_GamePlatform_Model$ground,
			_1: {ctor: '[]'}
		}
	},
	avatar: _user$project$Game_Avatar_Model$model
};
...
var _user$project$Model$HighScore = F2(
	function (a, b) {
		return {name: a, score: b};
	});
var _user$project$Model$Model = F5(
	function (a, b, c, d, e) {
		return {size: a, game: b, screen: c, highScores: d, playerName: e};
	});
var _user$project$Model$GameOverScreen = {ctor: 'GameOverScreen'};
var _user$project$Model$PlayScreen = {ctor: 'PlayScreen'};
...
var _user$project$View$divStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'margin', _1: '-80px 0 0 -180px'},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'z-index', _1: '15'},
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$View$inputStyle = _elm_lang$html$Html_Attributes$style(
	{
		...
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'padding', _1: '10px 15px'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'font-size', _1: '1.5em'},
				_1: {
...
var _user$project$View$leftAlignColumn = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'text-align', _1: 'left'},
		_1: {ctor: '[]'}
	});
var _user$project$View$highScoreRow = function (highScore) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$View$leftAlignColumn,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(highScore.name),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(highScore.score)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$View$highScoreTable = function (highScores) {
	return A2(
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _user$project$View$highScoreRow, highScores)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$View$divStyle,
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('[ Press ENTER to begin ]'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text('You are playing as: '),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$InputName),
												_1: {
													ctor: '::',
													_0: _user$project$View$inputStyle,
													_1: {ctor: '[]'}
												}
											}
										}
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('High Scores'),
									_1: {
										ctor: '::',
										_0: _user$project$View$highScoreTable(model.highScores),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Main$subscriptions = function (subscriptions) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$keyboard$Keyboard$ups(_user$project$Update$KeyUp),
					_1: {
						ctor: '::',
						_0: _elm_lang$window$Window$resizes(_user$project$Update$Resize),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {
			...
			_1: A2(_elm_lang$core$Task$perform, _user$project$Update$Resize, _elm_lang$window$Window$size)
		},
